...
class App extends React.Component {
	...
	handleInput(event) {
		...
		if (!this.state.begin) { this.setState({ begin: true }); }
	...
	render() {
		return (
			<div>
				<CodeComponent begin = {this.state.begin} cursor = {this.state.cursor} code = {this.state.code} />
			</div>
		);
	}
};
...
class CodeComponent extends React.Component {
	render() {
		...
		return (
			<div>
				<pre className = "language-js" id = "codeContainer">
